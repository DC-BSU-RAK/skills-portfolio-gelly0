...
class JokeApp:
    def __init__(self, root):
        ...
        self.start_bg = PhotoImage(file="1.png").subsample(
            1024 // 900 if 1024 > 900 else 1,
            768 // 600 if 768 > 600 else 1
        )
        self.joke_bg = PhotoImage(file="2.png").subsample(
            1024 // 900 if 1024 > 900 else 1,
            768 // 600 if 768 > 600 else 1
        )

        # Sound paths
        self.laugh_sound = "laugh.wav"
        self.bg_music = "bg_music.wav"
    ...
    def play_laugh(self):
        ...
        # Delay long enough so laugh isn't cut
    ...
    def show_punchline(self):
        ...
        # Update UI before speech
        self.root.update_idletasks()
        self.root.update()

        # Speak punchline first
